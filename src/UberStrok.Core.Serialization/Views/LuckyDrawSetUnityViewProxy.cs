...
namespace UberStrok.Core.Serialization.Views
{
    public static class LuckyDrawSetUnityViewProxy
    {
        public static LuckyDrawSetUnityView Deserialize(Stream bytes)
        {
            ...
            LuckyDrawSetUnityView view = new LuckyDrawSetUnityView
            {
                CreditsAttributed = Int32Proxy.Deserialize(bytes),
                ExposeItemsToPlayers = BooleanProxy.Deserialize(bytes),
                Id = Int32Proxy.Deserialize(bytes)
            };
